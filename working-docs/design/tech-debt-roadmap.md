...
Items 1-3 and 5 come from a tech-debt audit on 2026-09-19.
...
## 3. Tier 3 Java path is untested and silent on failure — Priority 15
...
## 4. GPL/LGPL/AGPL family disambiguation (tail recall floor) — Priority 12
...
## 5. `scripts/` and `benchmarks/` are not linted in CI — Priority 12
...
## 6. Probe-anchored windowing — Priority 9
...
## 7. Apache-2.0 vs Pixar near-duplicate confusion — Priority 6
