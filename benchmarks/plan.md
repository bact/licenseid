...
The benchmark will utilize the test fixtures already present in the `license-marker` branch (e.g., under `tests/fixtures/license-text-long` and `tests/fixtures/mixed-content`).
...
For 1, use tests/fixtures/license-id/.
For 2, use tests/fixtures/license-name/.
For 3, use tests/fixtures/license-text-short/.
For 4, use tests/fixtures/license-text-long/.
For 5, use tests/fixtures/mixed-content/.
